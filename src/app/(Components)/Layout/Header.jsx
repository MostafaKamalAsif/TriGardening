  ...
  return (
    ...
    <Container>
      ...
      <h2 className='font-semibold text-[32px] text-white -ml-6'>TriGardening</h2>
        ...
        <div className="">
          <Button className={"rounded-[14px] pl-2.5 pr-5 py-2 text-[22px] flex items-center gap-x-[9px] "}><IoCall className='text-white'/> Call Now</Button>
       
        </div>
        <div className="relative">
          <input type="text" placeholder='Search plants, tools' className='placeholder:text-[22px] placeholder:text-white border rounded-full pl-[22px] py-2 pr-[88px]  ' />
          <IoSearchSharp className='absolute top-[50%]  right-[20px] -translate-y-[50%] text-2xl '/>
        </div>
