...
const ProductCard = ({Productimg,Name,Type, Price,review}) => {
  return (
    <>
    <div className="w-[359px] h-[543px] rounded-[20px] bg-[#FFFFFF] relative group">
 ...
 <h3 className='text-[22px] font-medium pl-0.5 text-[#2D5016]'>{review}</h3>
        ...
        <Button className={'py-[22px] pl-[92px] pr-[81px] w-fit ml-6 mr-8.5  text-white bg-[#2D5016] text-[22px] font-semibold rounded-[10px] mt-5 mb-[274px]'}>Add to Cart</Button>
