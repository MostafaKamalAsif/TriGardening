...
<CategoryList text={'Low Light (16)'}/>
        ...
        <Button className={'text-[#FFFFFF] text-[17px] font-semibold bg-[#7A9B57] rounded-[10px] px-[70px] py-2.5 mt-[25px] cursor-pointer'}>Apply Filters</Button>
        </div>

        <div className="">
          <div className="flex gap-x-[567px] items-center">
            <div className=""><h3 className='text-[#404040] text-[40px] font-semibold '>Plants</h3>
          <p className='text-[#404040] text-xl pb-7'>Showing 10 of 40 products</p></div>
        
         <div className="">
          <div className="text-[#404040] text-[20px] flex items-center  gap-x-[63px] bg-[#FFFFFF] rounded-[10px] pl-[29px] pr-[18px] py-[15px]  cursor-pointer  border border-[#B7B7B7]">Sorty By: Popular <IoIosArrowDown/> </div>
         </div>
          </div>
...
<ProductCard Productimg={Stroobants} Name={'Snake Plant'} Type={"Indoor Plant"} Price={" 150- 500 "} review={"(35)"}/>
            ...
            <Button className={'text-[#FFFFFF] text-[22px] font-semibold bg-[#7A9B57] rounded-[10px] px-10 py-4.5 mt-[113px] cursor-pointer w-fit ml-100'}>Load More Products</Button>
        </div>
      </Container>
    </div>
    </>
